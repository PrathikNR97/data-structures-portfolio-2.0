...
Full analysis code (data loading, cleaning, and chart generation): `[(https://github.com/your-github-handle/your-repo-name](https://github.com/PrathikNR97/data-structures-portfolio-2.0/tree/main))` — see `generate_graphs.py`.
